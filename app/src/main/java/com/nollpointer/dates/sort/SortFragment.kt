...
class SortFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val preDates: ArrayList<Date?>? = arguments!!.getParcelableArrayList(PractiseConstants.DATES)
        preDates!!.forEach {
...
//        }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(dates: ArrayList<Date>, difficulty: Int, testMode: Boolean): SortFragment {
            val sort = SortFragment()
            val bundle = Bundle()
            bundle.putBoolean(TEST_MODE, testMode)
            bundle.putInt(DIFFICULTY, difficulty)
            bundle.putParcelableArrayList(MainActivity.DATES, dates)
            sort.arguments = bundle
            return sort
        }
    }
}